      ...
      <div>
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" role="menu">
          <div class="p-2 d-flex">
            <a class="dropdown-item" href="/data" data-bs-target="#myModal" data-bs-toggle="modal">
              <img style="margin-right: 13px;" src="@/assets/img/icons/aktivitas_dropdown.png" />Buat Task Baru
            </a>
          </div>
          <div class="p-2 d-flex">
            <a class="dropdown-item" href="/data" data-bs-target="#myModal" data-bs-toggle="modal">
              <img style="margin-right: 13px;" src="@/assets/img/icons/aktivitas_dropdown.png" />Edit Task
            </a>
          </div>
          <div class="p-2 d-flex">
            <a class="dropdown-item" href="/data" data-bs-target="#myModal" data-bs-toggle="modal">
              <img style="margin-right: 13px;" src="@/assets/img/icons/aktivitas_dropdown.png" />Edit Status
            </a>
          </div>
        </ul>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form>
                  ...
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Judul Task</label>
                    <input
                      type="text"
                      class="form-control"
                  ...
                  <div class="mb-3">
                    <label for="floatingTextarea2">Deskripsi Task</label>
                    <textarea
                      class="form-control"
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary">Buat Task</button>
              </div>
            </div>
          </div>
        </div>
